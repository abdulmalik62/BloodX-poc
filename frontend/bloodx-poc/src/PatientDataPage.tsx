...
const PatientDataPage: React.FC = () => {
    const [patientData, setPatientData] = useState<FormData[]>([]);
    ...
    useEffect(() => {
        ...
        // const data = JSON.parse(localStorage.getItem('patiendData') || '[]');
        // setPatientData(data);
    }, []);
    ...
    const handleActionClick = (index: number,action: string) => {
        const updatedData = [...patientData];
